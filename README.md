...
- **Pure JavaScript**: Ported from Python, runs entirely in the browser
...
Note: The CLI version is missing some features. Check out the Python version for additional debugging tools.
